...
with open('adminZodiacAutoCarousel.js', 'r', encoding='utf-8') as f:
    code = f.read()

bad_chunk = """    if (combinedLength > 350) { fontSize = 21; lineH = 1.2; nameSize = 36; imgSize = 230; gap = 5; }
    
                <span style="color: #d4af37;">คำแนะนำ:</span> ${card.future}
            </div>"""

good_chunk = """    if (combinedLength > 350) { fontSize = 21; lineH = 1.2; nameSize = 36; imgSize = 230; gap = 5; }
    ...
    container.innerHTML = `
        ...
        <div class="tarot-content-wrapper" style="padding: ${gap}px 0;">
            ...
            <img src="${cardImgUrl}" class="tarot-card-img" style="height: ${imgSize}px; margin: 0 auto; display: block; border-radius: 10px; border: 2px solid #d4af37; margin-bottom: 0;" />
...
with open('adminZodiacAutoCarousel.js', 'w', encoding='utf-8') as f:
    f.write(code)
