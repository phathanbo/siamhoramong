...
function generateVIPReport() {
    ...
    htmlContent += `
        <div class="pdf-page cover-page" style="width: 210mm; height: 297mm; max-height: 297mm; overflow: hidden; box-sizing: border-box; background-image: url('../assets/mystical_astrology_cover.png') !important; background-size: cover !important; background-position: center !important; text-align: center; display: block; position: relative; padding: 0; border: none; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important;">
            ...
            <!-- Customer Name Banner (Placed in the lower-middle dark segment, directly below the zodiac wheel) -->
            <div style="position: absolute; top: 560px; left: 50%; transform: translateX(-50%); width: 80%; z-index: 10; background: linear-gradient(135deg, rgba(20, 10, 45, 0.85), rgba(10, 5, 25, 0.9)) !important; padding: 18px 25px; border-radius: 12px; border: 1.5px solid rgba(212, 175, 55, 0.45) !important; box-shadow: 0 12px 30px rgba(0,0,0,0.9); text-align: center;">
                <div style="color: #D4AF37 !important; font-size: 14px; letter-spacing: 2px; font-weight: 600; margin-bottom: 4px; text-transform: uppercase;">
                    เจ้าชะตาผู้เป็นเจ้าของคำทำนาย
                </div>
                <div style="color: #FFFFFF !important; font-size: 34px; font-weight: 700; text-shadow: 0 2px 8px rgba(0,0,0,0.9); font-family: 'Sarabun', sans-serif;">
                    คุณ${name}
                </div>
            </div>
    ...
    htmlContent += `
        <div class="pdf-page cover-page" style="width: 210mm; height: 297mm; max-height: 297mm; overflow: hidden; box-sizing: border-box; background-image: url('../assets/mystical_astrology_cover.png') !important; background-size: cover !important; background-position: center !important; text-align: center; display: block; position: relative; padding: 0; border: none; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important;">
            ...
            <!-- Top Logo Content (Positions Siamhora at the top banner area) -->
            <div style="position: absolute; top: 110px; left: 0; width: 100%; text-align: center; z-index: 5; padding: 0 40px; box-sizing: border-box;">
                <div style="color: #FFFFFF !important; font-size: 52px; font-weight: 700; text-shadow: 0 4px 12px rgba(0,0,0,0.95); font-family: 'Sarabun', sans-serif;">สยามโหรามงคล</div>
                <div style="color: #D4AF37 !important; font-size: 18px; letter-spacing: 4px; font-weight: 500; text-transform: uppercase; margin-top: 5px; text-shadow: 0 2px 5px rgba(0,0,0,0.8);">
                    ศาสตร์แห่งจักรวาลและดวงดาวพยากรณ์
                </div>
                <div style="width: 120px; height: 1.5px; background: linear-gradient(90deg, transparent, #D4AF37, transparent); margin: 15px auto 0 auto;"></div>
            </div>

            <!-- Decorative Center Ornament (Positioned precisely over the wheel) -->
            ...
            <!-- Bottom Content (Contact Info placed in the bottom dark background block to align with cover details card) -->
            ...
            <div style="position: absolute; bottom: 40px; left: 0; width: 100%; text-align: center; z-index: 10;">
                <div style="font-size: 12px; color: rgba(255, 255, 255, 0.35) !important; letter-spacing: 1px;">
                    ขอบพระคุณที่ร่วมเดินทางไปกับสยามโหรามงคล 🌌 ขอให้ท่านประสบแต่ความสุขความเจริญ
                </div>
            </div>
        </div>
    `;
