                ...
                <div class="card-body text-center p-5">
                    ...
                    <div id="setupExtension">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <label class="text-gold small text-left d-block mb-1" style="font-weight:bold;">👤 เลือกสมาชิกจากประวัติ</label>
                                <select class="form-control bg-dark text-white border-gold mb-3 member-selector-shared" onchange="autoFillMemberData(this.value)">
