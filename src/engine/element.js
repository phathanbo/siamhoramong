...
function getBirthElement(dayIndex) {
    if (dayIndex === 8 || dayIndex === "พุธกลางคืน" || dayIndex === "ราหู") {
        return { name: "ธาตุลม", level: "(ลมพายุ-ราหู)", color: "#708090", desc: "กล้าหาญ รักอิสระ ไหวพริบเลิศ รู้เท่าทันคน" };
    }
    const idx = typeof dayIndex === "number" ? dayIndex : 0;
    if (idx < 0 || idx > 6) {
        return { name: "ไม่ระบุ", color: "#ccc", desc: "-" };
    }
    return ELEMENT_INFO[idx] || { name: "ไม่ระบุ", color: "#ccc", desc: "-" };
}
...
function getElementRelation(baseElem, supportElem) {
    ...
    const relations = {
        "ธาตุไฟ": {
            ...
            "ธาตุไม้": "เกื้อกูล (ไม้เป็นเชื้อเพลิงหล่อเลี้ยงไฟ)",
            "ธาตุดิน": "ถ่ายเท (ไฟเผาผลาญกลายเป็นขี้เถ้าดิน)",
            "ธาตุทอง": "พิฆาต (ไฟหลอมละลายทองและโลหะ)",
            "ธาตุน้ำ": "พิฆาต (น้ำข่มดับไฟ)"
        },
        "ธาตุดิน": {
            "ธาตุไฟ": "หนุนส่ง (ไฟเผาผลาญกลายเป็นดิน)",
            "ธาตุทอง": "ถ่ายเท (ดินบ่มเพาะแร่ธาตุและทอง)",
            "ธาตุน้ำ": "พิฆาต (ดินกั้นและถมน้ำ)",
            "ธาตุไม้": "พิฆาต (รากไม้ชอนไชทำลายดิน)",
            "ธาตุลม": "ขัดเกลา (ลมพัดพาหน้าดินให้แห้ง)"
        },
        "ธาตุลม": {
            "ธาตุไฟ": "หนุนส่ง (ลมช่วยพัดให้ไฟแรงและโชติช่วง)",
            "ธาตุน้ำ": "หนุนส่ง (ลมพากระแสฝนและเมฆหมอก)",
            "ธาตุไม้": "เกื้อกูล (ลมช่วยกระจายเกสรไม้ให้เติบโต)",
            "ธาตุดิน": "ถ่ายเท (ลมพัดพาหน้าดินและฝุ่นละออง)",
            "ธาตุทอง": "พิฆาต (โลหะ/กำแพงต้านกระแสลม)"
        },
        "ธาตุน้ำ": {
            "ธาตุทอง": "หนุนส่ง (โลหะหลอมเหลวเป็นน้ำ/เรียกฝน)",
            "ธาตุไม้": "ถ่ายเท (น้ำหล่อเลี้ยงต้นไม้ให้เติบโต)",
            "ธาตุลม": "เกื้อกูล (ลมพาความชื้นและเมฆฝน)",
            "ธาตุไฟ": "พิฆาต (น้ำดับไฟ)",
            "ธาตุดิน": "พิฆาต (ดินกั้นและถมน้ำ)"
        },
        "ธาตุไม้": {
            "ธาตุน้ำ": "หนุนส่ง (น้ำหล่อเลี้ยงต้นไม้และรากแก้ว)",
            "ธาตุดิน": "เกื้อกูล (ไม้หยั่งรากยึดเกาะในดิน)",
            "ธาตุลม": "เกื้อกูล (ลมช่วยกระจายเมล็ดพันธุ์และเกสร)",
            "ธาตุไฟ": "ถ่ายเท (ไม้เผาไหม้กลายเป็นเชื้อเพลิงให้ไฟ)",
            "ธาตุทอง": "พิฆาต (ขวานและโลหะตัดกิ่งไม้)"
        },
        "ธาตุทอง": {
            "ธาตุดิน": "หนุนส่ง (ดินสร้างและบ่มเพาะแร่ธาตุ)",
            "ธาตุน้ำ": "ถ่ายเท (ทองละลายเป็นน้ำและสร้างความเย็น)",
            "ธาตุไฟ": "พิฆาต (ไฟหลอมละลายทองและโลหะ)",
            "ธาตุไม้": "พิฆาต (ขวาน/โลหะตัดต้นไม้)",
            "ธาตุลม": "ขัดเกลา (โลหะต้านแรงกระแทกของลม)"
        }
    };
