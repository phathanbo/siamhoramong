...
function renderPredictions(sex, lagnaIdx, pl, nak, weekDay, elem, animal, yearBE) {
  ...
  const lagnaDescs = [
    'มีลักษณะกล้าหาญ ขยันขันแข็ง ใจร้อน โกรธง่ายหายเร็ว มีความเป็นผู้นำสูง และทำสิ่งต่างๆ ด้วยความรวดเร็ว (อิทธิพลดาวอังคาร)',
    'มีนิสัยอดทน หนักแน่น มั่นคง รักความสงบและศิลปะความงาม มัธยัสถ์ รู้จักเก็บออม (อิทธิพลดาวศุกร์)',
    'มีสติปัญญาดี ช่างพูดช่างเจรจา เรียนรู้เร็ว ปรับตัวเก่ง มีความว่องไวสูง เข้าสังคมเก่ง (อิทธิพลดาวพุธ)',
    'มีจิตใจอ่อนโยน อ่อนไหวง่าย ขี้สงสาร รักและผูกพันกับครอบครัว มักคอยห่วงใยดูแลผู้อื่น (อิทธิพลดาวจันทร์)',
    'รักเกียรติยศและศักดิ์ศรี ใจกว้างขวาง มีความเป็นผู้นำ ทะเยอทะยาน และต้องการการยอมรับ (อิทธิพลดาวอาทิตย์)',
    'เป็นคนละเอียดรอบคอบ ช่างสังเกต มีสติปัญญาเฉียบแหลม ทำงานมีระเบียบวินัยและระมัดระวังตัว (อิทธิพลดาวพุธ)',
    'รักความยุติธรรม มีมนุษยสัมพันธ์ดีเยี่ยม รักสวยรักงาม เข้าสังคมเก่งและมีเสน่ห์ดึงดูด (อิทธิพลดาวศุกร์)',
    'มีจิตใจเด็ดเดี่ยว เก็บความรู้สึกเก่ง รักแรงเกลียดแรง มีความอดทนสูง และเด็ดขาด (อิทธิพลดาวอังคาร)',
    'มีปัญญาดี ใฝ่รู้ รักความยุติธรรม ยึดมั่นในศีลธรรมและเหตุผล มีเมตตาเอื้อเฟื้อเผื่อแผ่ (อิทธิพลดาวพฤหัสบดี)',
    'มีความมุมานะ ทรหดอดทนต่อความยากลำบาก จริงจังกับชีวิต มักคิดมากและเก็บความรู้สึก (อิทธิพลดาวเสาร์)',
    'มีใจนักเลง กล้าได้กล้าเสีย รักเพื่อนพ้อง โผงผาง เข้าสังคมเก่ง มีเล่ห์เหลี่ยมชั้นเชิง (อิทธิพลดาวราหู)',
    'เป็นผู้มีจิตใจโอบอ้อมอารี สุขุมเยือกเย็น มีเมตตาธรรม รักความสงบและมีสติปัญญาดี (อิทธิพลดาวพฤหัสบดี)',
  ];
  preds.push({ icon:'🔮', title:'บุคลิกภาพ — ลัคน์ราศี' + RASI[lagnaIdx], text: lagnaDescs[lagnaIdx] });

  // 2. จิตใจและอารมณ์ จากพระจันทร์
  const moonDescs = [
    'อารมณ์รวดเร็ว ตัดสินใจเด็ดขาด ใจร้อน มักโกรธง่ายแต่หายเร็ว',
    'อารมณ์มั่นคง จิตใจเยือกเย็น ยึดมั่นในความรู้สึก ไม่เปลี่ยนแปลงง่ายๆ',
    'จิตใจว่องไว ชอบเจรจาพาที ปรับตัวเก่ง แต่อารมณ์เปลี่ยนแปลงง่าย',
    'จิตใจอ่อนโยน อ่อนไหวง่าย ผูกพันกับคนใกล้ชิด ชอบดูแลปกป้อง',
    'จิตใจมุ่งมั่น รักศักดิ์ศรี หยิ่งทระนง ต้องการเกียรติยศและการยอมรับ',
    'จิตใจละเอียดอ่อน ช่างคิดช่างวิเคราะห์ ระมัดระวังตัวและมีเหตุผล',
    'จิตใจรักความสงบ ต้องการความยุติธรรม ชอบความประนีประนอมและศิลปะ',
    'อารมณ์ลึกซึ้ง เด็ดเดี่ยว มักเก็บงำความรู้สึก รักแรงเกลียดแรง',
    'จิตใจใฝ่รู้ รักความยุติธรรม ยึดมั่นในความดีงามและมีเมตตาธรรม',
    'จิตใจจริงจัง อดทนต่อความกดดันสูง มักวิตกกังวลและเก็บความรู้สึก',
    'จิตใจกล้าได้กล้าเสีย รักพวกพ้อง มักลุ่มหลงหรือยึดติดในสิ่งที่สนใจ',
    'จิตใจโอบอ้อมอารี สุขุม รักความสงบ มีความเห็นอกเห็นใจผู้อื่น',
  ];
  preds.push({ icon:'🌙', title:'จิตใจ — พระจันทร์ราศี' + RASI[moonSign], text: moonDescs[moonSign] });

  // 3. การงานและโชคลาภ จากพระพฤหัส
  const jupDescs = [
    'พระพฤหัสบดีในเมษ เหมาะทำธุรกิจที่ต้องบุกเบิก งานผู้นำ งานที่ต้องใช้ความเด็ดขาด',
    'พระพฤหัสบดีในพฤษภ นำโชคในเรื่องทรัพย์สิน การลงทุน และความมั่งคั่ง',
    'พระพฤหัสบดีในมิถุน ส่งเสริมด้านการเจรจาติดต่อ การเขียน และงานด้านวิชาการ',
    'พระพฤหัสบดีในกรกฎ (ได้ตำแหน่งอุจจ์) ส่งเสริมให้ประสบความสำเร็จอย่างสูงในหน้าที่การงานและได้รับการสนับสนุน',
    'พระพฤหัสบดีในสิงห์ ส่งเสริมชื่อเสียง เกียรติยศ และตำแหน่งหน้าที่การงาน',
    'พระพฤหัสบดีในกันย์ ส่งเสริมงานด้านการวิเคราะห์ เอกสาร งานบริการ และสาธารณสุข',
    'พระพฤหัสบดีในตุลย์ ส่งเสริมด้านความสัมพันธ์ หุ้นส่วนธุรกิจ และงานด้านกฎหมาย',
    'พระพฤหัสบดีในพิจิก ส่งเสริมความสำเร็จจากการแก้ปัญหา การวิจัย หรือได้ประโยชน์จากของเก่า',
    'พระพฤหัสบดีในธนู (ได้ตำแหน่งเกษตร) นำโชคลาภและความสำเร็จที่มั่นคง มักเกี่ยวข้องกับวิชาการหรือต่างประเทศ',
    'พระพฤหัสบดีในมกร (ได้ตำแหน่งนิจ) ต้องฝ่าฟันอุปสรรคก่อนจึงจะประสบความสำเร็จ อาศัยความอดทนเป็นที่ตั้ง',
    'พระพฤหัสบดีในกุมภ์ ส่งเสริมโชคลาภจากวงสังคม โครงการขนาดใหญ่ หรืองานที่เกี่ยวกับสิ่งใหม่ๆ',
    'พระพฤหัสบดีในมีน (ได้ตำแหน่งเกษตร) ส่งเสริมสติปัญญา ความสำเร็จในบั้นปลายชีวิต และโชคลาภอย่างสมบูรณ์',
  ];
  preds.push({ icon:'♃', title:'การงานและโชคลาภ — พระพฤหัสราศี' + RASI[jupSign], text: jupDescs[jupSign] });

  // 4. ปีนักษัตรและโชคชะตา
  const animalDescs = {
    'ชวด':'ปีชวดนำความฉลาด ปรับตัวเก่ง มีไหวพริบสูง ช่างสังเกต',
    'ฉลู':'ปีฉลูให้ความอดทน ซื่อสัตย์ ทำงานหนัก ได้รับผลช้าแต่มั่นคง',
    'ขาล':'ปีขาลให้ความกล้าหาญ มีพลังงาน เป็นผู้นำ ดึงดูดความสนใจ',
    'เถาะ':'ปีเถาะให้ความอ่อนโยน เฉลียวฉลาด มีเสน่ห์ โชคดีในความรัก',
    'มะโรง':'ปีมะโรงให้บารมีสูง มีโชค ฉลาด มีความลึกลับน่าค้นหา',
    'มะเส็ง':'ปีมะเส็งให้ปัญญาเฉียบแหลม รอบคอบ มีไหวพริบ แต่บางครั้งระแวง',
    'มะเมีย':'ปีมะเมียให้ความแข็งแกร่ง มีพลัง เป็นอิสระ ชอบทำงานคนเดียว',
    'มะแม':'ปีมะแมให้ความสุภาพ มีศิลปะ เป็นที่รัก ชอบความสวยงาม',
    'วอก':'ปีวอกให้ความฉลาดรอบด้าน ปรับตัวเก่ง มีความคิดสร้างสรรค์',
    'ระกา':'ปีระกาให้ความขยัน ตรงไปตรงมา มีเกียรติ ทำงานดี',
    'จอ':'ปีจอให้ความซื่อสัตย์ จงรักภักดี มีมิตรมาก ยุติธรรม',
    'กุน':'ปีกุนให้ความสุจริต ขยันขันแข็ง เก็บออม รักสันติ',
  };
  preds.push({ icon:'🐲', title:'ปีนักษัตร — ปี' + animal, text: animalDescs[animal] || 'มีโชคดีตามปีนักษัตร' });

  // 5. ฤกษ์เกิด
  const nakPreds = [
    'ฤกษ์อัศวินี — มีพลังชีวิตสูง เริ่มต้นสิ่งใหม่เก่ง มีความกระตือรือร้น',
    'ฤกษ์ภรณี — มีความแน่วแน่ รับผิดชอบ บางครั้งดื้อรั้น แต่มีความสามารถสูง',
    'ฤกษ์กฤตติกา — มีพลังและความมุ่งมั่น ชอบตัดสิ่งที่ไม่จำเป็น เข้าถึงเป้าหมายตรง',
    'ฤกษ์โรหิณี — มีเสน่ห์สูง โชคดีในความรัก มีรสนิยมดี ชอบความสุขทางกาย',
    'ฤกษ์มฤคศิร — ช่างสงสัย ใฝ่รู้ เดินทางมาก มีสติปัญญาดี',
    'ฤกษ์อาร์ทรา — มีพลังงานสูง บางครั้งรุนแรง แต่มีความสามารถที่ซ่อนอยู่',
    'ฤกษ์ปุนรวสุ — มีโชค ฟื้นตัวจากปัญหาเก่ง มีความสุขในชีวิต',
    'ฤกษ์ปุษยะ — เป็นฤกษ์มงคล มีความเมตตา ได้รับการช่วยเหลือเสมอ',
    'ฤกษ์อาศเลษา — มีพลังลึกลับ ฉลาดเฉลียว แต่ต้องระวังเรื่องความไว้วางใจ',
    'ฤกษ์มฆา — มีบุญบารมี ตระกูลดี มีความเป็นผู้นำ',
    'ฤกษ์ปูรวาผัลคุนี — รักความสุข มีเสน่ห์ ชีวิตมีสีสัน',
    'ฤกษ์อุตตราผัลคุนี — มีความมั่นคง ได้รับการสนับสนุน มีมิตรดี',
    'ฤกษ์หัสตา — ปราดเปรียว ทำงานเร็ว มีทักษะทางมือ',
    'ฤกษ์จิตรา — มีความคิดสร้างสรรค์ ชอบความสวยงาม มีพรสวรรค์ด้านศิลปะ',
    'ฤกษ์สวาติ — รักอิสระ เป็นกลาง มีความยืดหยุ่น',
    'ฤกษ์วิศาขา — มีความมุ่งมั่น บรรลุเป้าหมายได้ มีพลังงานสูง',
    'ฤกษ์อนุราธา — มีมิตรภาพดี เข้าสังคมเก่ง มีความภักดี',
    'ฤกษ์เชษฐา — มีอำนาจ กล้าหาญ ได้รับการยอมรับ',
    'ฤกษ์มูลา — มีรากฐานแน่น ชอบค้นหาความจริง บางครั้งทำลายเพื่อสร้างใหม่',
    'ฤกษ์ปูรวาอาษาฒา — มีพลังน้ำ ปรับตัวดี มีชัยชนะในที่สุด',
    'ฤกษ์อุตตราอาษาฒา — มีชัยชนะมั่นคง ซื่อสัตย์ มีคุณธรรม',
    'ฤกษ์ศระวณา — ช่างฟัง เรียนรู้เก่ง มีปัญญาและเกียรติ',
    'ฤกษ์ธนิษฐา — มีทรัพย์สิน ชอบดนตรี มีพลังและความมั่งคั่ง',
    'ฤกษ์ศตภิษา — มีความลึกลับ ชอบวิทยาศาสตร์ มีพลังรักษา',
    'ฤกษ์ปูรวาภาทระปทา — มีพลังสูง บางครั้งรุนแรง แต่มีจิตวิญญาณสูงส่ง',
    'ฤกษ์อุตตราภาทระปทา — มีปัญญาลึก สงบ มีเมตตาธรรม',
    'ฤกษ์เรวดี — อ่อนโยน ใจดี มีพรสวรรค์ด้านศิลปะและจิตวิญญาณ',
  ];
