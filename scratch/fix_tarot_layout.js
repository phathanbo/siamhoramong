...
function fixFile(filepath) {
    ...
    // 2. Update HTML
    const old_html = `        <div class="tarot-content-wrapper" style="padding: \${gap}px 0;">
    ...
    const old_html_carousel = old_html.replace("<div class=\"tarot-card-img\" style=\"background-image: url('${cardImgUrl}'); height: ${imgSize}px; width: ${imgSize * 0.6}px; background-size: cover; margin-bottom: 0;\">\n            </div>", 
    ...
    const new_html = `        <div class="tarot-content-wrapper" style="padding: \${gap + 10}px 0; height: auto; min-height: 100%; box-sizing: border-box; justify-content: center;">
    ...
    const new_html_carousel = new_html.replace("<div class=\"tarot-card-img\" style=\"background-image: url('${cardImgUrl}'); height: ${imgSize}px; width: ${imgSize * 0.6}px; background-size: cover; margin: 0 auto; border-radius: 10px; border: 2px solid #d4af37;\">\n            </div>", 
        '<img src="${cardImgUrl}" class="tarot-card-img" style="height: ${imgSize}px; margin: 0 auto; display: block; border-radius: 10px; border: 2px solid #d4af37; margin-bottom: 0;" crossorigin="anonymous" />');
...
fixFile('d:\\\\สยามโหรามงคล\\\\adminAutoPost.js');
fixFile('d:\\\\สยามโหรามงคล\\\\adminZodiacAutoCarousel.js');
